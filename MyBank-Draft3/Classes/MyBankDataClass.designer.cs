...
namespace MyBank_Draft3.Classes
{
	...
	public partial class MyBankDataClassDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void DeleteUserWallet(UserWallet instance);
		...
		public MyBankDataClassDataContext() : 
				base(global::MyBank_Draft3.Properties.Settings.Default.MyBankConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public MyBankDataClassDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public MyBankDataClassDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public MyBankDataClassDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnAdmin_PasswordChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_Admin", Storage="_User", ThisKey="User_ID", OtherKey="User_ID", IsForeignKey=true)]
		public User User
		{
			get
			{
	...
	public partial class Customer : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<UserWallet> _UserWallet;
    ...
    partial void OnCustomer_PasswordChanged();
		...
		{
			this._User = default(EntityRef<User>);
			this._UserWallet = default(EntityRef<UserWallet>);
			OnCreated();
		}
		...
		public int UserWallet_ID
		{
			...
			set
			{
				...
				{
					if (this._UserWallet.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="UserWallet_Customer", Storage="_UserWallet", ThisKey="UserWallet_ID", OtherKey="UserWallet_ID", IsForeignKey=true)]
		public UserWallet UserWallet
		{
			get
			{
				return this._UserWallet.Entity;
			}
			set
			{
				UserWallet previousValue = this._UserWallet.Entity;
				if (((previousValue != value) 
							|| (this._UserWallet.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._UserWallet.Entity = null;
						previousValue.Customers.Remove(this);
					}
					this._UserWallet.Entity = value;
					if ((value != null))
					{
						value.Customers.Add(this);
						this._UserWallet_ID = value.UserWallet_ID;
					}
					else
					{
						this._UserWallet_ID = default(int);
					}
					this.SendPropertyChanged("UserWallet");
				}
			}
		}
    ...
    partial void OnRole_IDChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_Admin", Storage="_Admins", ThisKey="User_ID", OtherKey="User_ID")]
    ...
    partial void OnUserWallet_CurrencyChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="UserWallet_Customer", Storage="_Customers", ThisKey="UserWallet_ID", OtherKey="UserWallet_ID")]
		public EntitySet<Customer> Customers
		{
			get
			{
		...
		{
			this.SendPropertyChanging();
			entity.UserWallet = this;
		}
		
		private void detach_Customers(Customer entity)
		{
			this.SendPropertyChanging();
			entity.UserWallet = null;
		}
	}
}
